	...
	stages{
		...
		agent { label 'dhfLinuxAgent'}
			steps{
				...
				export $WORKSPACE'+GRADLE_USER_HOME+' export '+MAVEN_HOME+' export PATH=$WORKSPACE'+GRADLE_USER_HOME+':$PATH:$MAVEN_HOME/bin; cd $WORKSPACE/data-hub;rm -rf $WORKSPACE'+GRADLE_USER_HOME+'/caches;./gradlew clean --stacktrace;./gradlew build -x test -Pskipui=true;'
