	...
	stages{
		...
		agent { label 'dhfLinuxAgent'}
			steps{
				...
				println(BRANCH_NAME)
				sh 'echo '+JAVA_HOME+'export '+JAVA_HOME+' export '+MAVEN_HOME+' export PATH=$PATH:$MAVEN_HOME/bin; cd $WORKSPACE/data-hub;./gradlew clean;./gradlew build -x test -Pskipui=true;'
